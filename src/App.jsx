      ...
      <nav>
        <div className="logo">
          ...
          <ul className={`${showItems? 'show-items' : ''}`}>
            ...
            <li className='dropdown-items-container' onClick={()=>{setShowDropdown(!showDropdown)}} >
              <Link to="#">Dropdown <img src="\src\img\arrow-down.png" alt="dropdown" /></Link>
                <ol  className={`dropdown-items ${showDropdown ? 'show-dropdown' : ''}`}>
            ...
            <li className='contact-button'><Link to="#">Contact</Link></li>
          </ul>
        <div className="toggle-button" onClick={()=>setShowItems(!showItems)}>
          <img src="\src\img\toggle-menu.png" alt="toggle" />
        </div>
      </nav>
      <main>
          <Routes>
